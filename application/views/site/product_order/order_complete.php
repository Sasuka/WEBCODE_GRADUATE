    ...
    <div >
        <div class="section">
            <div class="section-header os-header">
                <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000" stroke-width="2" class="hanging-icon checkmark"><path class="checkmark_circle" d="M25 49c13.255 0 24-10.745 24-24S38.255 1 25 1 1 11.745 1 25s10.745 24 24 24z">

                    </path><path class="checkmark_check" d="M15 24.51l7.307 7.308L35.125 19"></path></svg>
                <div class="os-header-heading">
                    <h2 class="os-header-title">
                        Đặt hàng thành công
                    </h2>
                    <span class="os-order-number">Mã đơn hàng #100010</span>
                        ...
                        <div class="section-content">
                            <div class="section-content-column">
                                ...
                                <p>sfsdf
                                    <br />dfdsfsfs
                                    <br />Thành phố Bà Rịa
                                    <br />Bà Rịa - Vũng Tàu<br />Vietnam<br />123131321<br />
                                </p>
        ...
        <div class="step-footer">
            <a href="http://happylive.vn" class="step-footer-continue-btn btn">
                <span class="btn-content">Tiếp tục mua hàng</span>
            </a>
            <p class="step-footer-info">
                <i class="icon icon-os-question"></i>
                <span>Cần hỗ trợ? <a href="mailto:happylivepro@gmail.com">Liên hệ chúng tôi</a></span>
            </p>
        </div>
    </div>
</div>
