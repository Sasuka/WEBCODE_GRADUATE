...
<link href="<?php echo public_url('site')?>/css/default_style.min.css?v=90" rel='stylesheet' type='text/css' media='all'/>
<!--[if lt IE 9]>
...
<script src="<?php echo public_url('site')?>/design/theme-default/jquery.touchSwipe.min.js" type='text/javascript'></script>
<script data-target=".product-resize" data-parent=".products-resize" data-img-box=".image-resize"
        src="<?php echo public_url('site')?>/design/js/fixheightproductv2.js"></script>
<script src="<?php echo public_url('site')?>/design/js/haravan.plugin.1.0.js"></script>
