...
$tmp['TEN_KHUYENMAI'] = (isset($_POST['name']) ? $_POST['name'] : $info['TEN_KHUYENMAI']);
$tmp['NGAY_BATDAU'] = (isset($_POST['begin']) ? $_POST['begin'] : $info['NGAY_BATDAU']);
$tmp['NGAY_KETTHUC'] = (isset($_POST['end']) ? $_POST['end'] : $info['NGAY_KETTHUC']);
...
<div class="wrapper">
    ...
    ?>
    <!-- Form -->
    <form class="form" id="form-promotion-edit" action="" method="post">
        <fieldset>
            <div class="widget">
                <div class="title">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input name="name" id="name" _autocheck="true"
                                                            type="text"
                                                            value="<?php echo $tmp['TEN_KHUYENMAI']; ?>"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input name="begin" id="begin" class="date" _autocheck="true"
                                                            type="text"
                                                            value="<?php echo $tmp['NGAY_BATDAU']; ?>"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input name="end" id="end" class="date" _autocheck="true"
                                                            type="text"
                                                            value="<?php echo $tmp['NGAY_KETTHUC']; ?>"></span>
...
<script>
    $(function () {
        ...
        $('#form-promotion-edit').submit(function (e) {
//
            var name = $('#name').val();
            var begin = $('#begin').val();
            var end = $('#end').val();
