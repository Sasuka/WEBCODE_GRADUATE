    ...
    <div class="widgets">
        ...
        <div class="widget">
            ...
            <table class="sTable mTable myTable" id="checkAll" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="21"
                                                                                 style="opacity: 0;"
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="20"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="19"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="18"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="17"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="16"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="15"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="14"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="13"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="checker" id="uniform-undefined"><span><input name="id[]" value="12"
                                                                                 style="opacity: 0;"
                                                                                 type="checkbox"></span></div>
                    </td>
